...
// 缩略图的支持
void Ctest4Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void Ctest4Doc::InitializeSearchContent()
{
...
void Ctest4Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
